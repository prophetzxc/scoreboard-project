...
document.getElementById('guest-plus-1').addEventListener('click', increment1Number2);
document.getElementById('guest-plus-2').addEventListener('click', increment2Number2);
document.getElementById('guest-plus-3').addEventListener('click', increment3Number2);
